...
class ChocoMalibanDetails extends StatefulWidget {
  @override
  _LoginScreenState createState() => _LoginScreenState();
}

class _LoginScreenState extends State<ChocoMalibanDetails> {
  final comment = TextEditingController();
  var Saftypercentage = 34;
  var nutrition = 18;
  var price = 17;
