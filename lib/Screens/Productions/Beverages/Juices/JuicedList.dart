...
class JuicedList extends StatefulWidget {
  @override
  _JuicedListState createState() => _JuicedListState();
}

class _JuicedListState extends State<JuicedList> {
