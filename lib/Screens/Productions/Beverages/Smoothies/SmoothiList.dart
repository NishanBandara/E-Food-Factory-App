...
class SmoothiList extends StatefulWidget {
  @override
  _SmoothiListState createState() => _SmoothiListState();
}

class _SmoothiListState extends State<SmoothiList> {
